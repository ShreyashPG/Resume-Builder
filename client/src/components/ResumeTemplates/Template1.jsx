...
import codechef from "../../assets/codechef.png";
import codeforces from "../../assets/codeforces.png";
// import DownloadIcon from "@mui/material/icons/Download";
import DownloadIcon from "@mui/icons-material/Download";
...
export default function Template1() {
  ...
  const handleDownload = async () => {
    try {
      ...
      // A4 size constants in points (jsPDF uses points)
  ...
  // Updated customStyle - removed height restrictions
  const customStyle = {
    width: "100%",
    maxWidth: "794px",
    minHeight: "1123px", // Changed from fixed height
    padding: "1rem 2rem 1rem 2rem",
    boxShadow: "0 4px 8px rgba(0, 0, 0, 0.3)",
    backgroundColor: "#ffffff",
    display: "flex",
    flexDirection: "column",
    overflow: "visible" // Added to prevent content clipping
  };
  ...
  return (
    <>
      ...
      >
        <Paper className="resume-container" elevation={2} style={customStyle} ref={ref}>
          <Box sx={{ flexShrink: 0 }}> {/* Changed from flexShrink: 4 to 0 */}
            {/* Heading - Only show once */}
            ...
            <div className="resume-content">
              ...
              <div className="left-section">
                {/* Education */}
                <div className="education-info page-break-avoid">
                  <div className="heading">Education</div>
                  <hr />
                  {/* Part 1 */}
                  {education.college && (
                ...
                {/* Skills */}
                {extraDetails?.skills?.languages && extraDetails?.skills.languages.length > 0 && (
                  <div className="skills page-break-avoid">
                    <div className="heading">Skills</div>
                    <hr />
                    {extraDetails?.skills.languages?.length > 0 && (
                      <>
                    ...
                    {extraDetails?.skills.webFrameworks?.length > 0 && (
                      <>
                        <h4 className="skill-names">WebFrameworks:</h4>
                        <div className="skillset">
                          <ul className="sk">
                            {extraDetails?.skills.webFrameworks?.map((skill, index) => (
                              <li key={index}>{skill}</li>
                ...
                {/* Links */}
                <div className="links page-break-avoid">
                  <div className="heading">Coding Profile</div>
                  <hr />
                  <div className="linkSets">
                    {profile.github && (
                    ...
                    {profile.leetcode && (
                      <div className="link-item">
                        <img src={leetcode} alt="leetcode" />
                        <div className="ls">
                          <a href={profile.leetcode} className="link" target="_blank" rel="noopener noreferrer">
                            {profile.lastName?.length > 6 ? (
                              <p>{profile.firstName?.toLowerCase()}</p>
                            ) : (
                              <>
                    ...
                    {profile.codechef && (
                      <div className="link-item">
                        <img src={codechef} alt="codechef" />
                        <div className="ls">
                          <a href={profile.codechef} className="link" target="_blank" rel="noopener noreferrer">
                            {profile.lastName?.length > 6 ? (
                              <p>{profile.firstName?.toLowerCase()}</p>
                            ) : (
                              <>
                    ...
                    {profile.codeforces && (
                      <div className="link-item">
                        <img src={codeforces} alt="codeforces" />
                        <div className="ls">
                          <a href={profile.codeforces} className="link" target="_blank" rel="noopener noreferrer">
                            {profile.lastName?.length > 6 ? (
                              <p>{profile.firstName?.toLowerCase()}</p>
                            ) : (
                              <>
                ...
                {/* Core Subjects */}
                <div className="subjects page-break-avoid">
                  <div className="heading">Core Subjects</div>
                  <hr />
                  <div className="subject-list">
                    <ul>
              ...
              <div className="right-section">
                ...
                {/* Achievements */}
                {extraDetails?.achievements && extraDetails?.achievements.length > 0 && (
                  <div className="achievements page-break-avoid">
                    <div className="heading">Achievements</div>
                    <hr />
                    <div className="list">
                      <ul>
                ...
                {/* Extra Curricular */}
                {extraDetails?.extraCoCurricular && extraDetails.extraCoCurricular.length > 0 && (
                  <div className="extra-curricular page-break-avoid">
                    <div className="heading">Extra Curricular</div>
                    <hr />
                    <div className="extra-list">
                      <ul>
                        {extraDetails?.extraCoCurricular?.map((extra, index) => (
                          <li className="value" key={index}>{extra}</li>
                        ))}
                      </ul>
                    </div>
                  </div>
